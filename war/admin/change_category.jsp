						...
						<div class="8u important(collapse)">
							...
							<!-- Content -->
								<article class="box post">
									<header>
										<h3><%=articleModel.getTitle() %></h3>
									</header>
									
									<form action="/admin/changeCategoryEntry" enctype="multipart/form-data" method="post">
										<input type="hidden" name="id" value="<%=articleModel.getKey().getId() %>">
										<section>
